...
import e02.jsp.JspParserStart;
import e02.request.IRequestHeaderParser;
...
public class Server extends Thread{
    ...
    public static void openServer() throws Exception {  
        server = new ServerSocket(Integer.parseInt("8888"));  
	...
	public void run(){
        ...
        try {  
            ...
            IRequestHeaderParser parser = (IRequestHeaderParser) Class.forName(  
            		"e02.request.RequestHeaderParser")  
            ...
            if(header.getUrl().endsWith(".jsp")){
            	...
            	String classTxt=JspParserStart.parse(str.toString(), className, "req", "res");
                ...
                response.out.println("already transform the jsp to servlet!");
                response.out.close();
